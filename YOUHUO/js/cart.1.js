         ...
         function refresh(){
           ...
           // console.log(data)
            ...
            if(data.length>0){
                ...
                var li = $(`<li class="clear li cartBox"></li>`).appendTo($('.cartList2'));
                var ol=$(`<ol class="ollist clear"></ol>`).appendTo(li);
                
                $( `<li>
                
                    <input type="checkbox"  class="son_check"><img src="${obj.img}">
                    <label></label>
                </li>
                <li>
